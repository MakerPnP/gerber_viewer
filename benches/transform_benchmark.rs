...
impl TestTransform {
    ...
    fn apply_to_position(&self, pos: Point2<f64>) -> Point2<f64> {
        ...
        // Apply translation
        Point2::new(
            rotated_x + self.translation_x,
            rotated_y + self.translation_y,
        )
    }
    ...
    fn to_matrix(&self) -> Matrix3<f64> {
        ...
        Matrix3::new(
            self.scale_x * cos_angle, -self.scale_y * sin_angle, self.translation_x,
            self.scale_x * sin_angle, self.scale_y * cos_angle, self.translation_y,
            0.0, 0.0, 1.0,
        )
    }
}
