...
impl GerberTransform {
    ...
    pub fn to_matrix(&self) -> Matrix3<f64> {
        ...
        let translate_neg_origin = Matrix3::new(
            1.0, 0.0, -self.origin.x,
            0.0, 1.0, -self.origin.y,
            0.0, 0.0, 1.0
        );
        ...
        let translate_origin = Matrix3::new(
            1.0, 0.0, self.origin.x,
            0.0, 1.0, self.origin.y,
            0.0, 0.0, 1.0
        );
    ...
    pub fn from_matrix(matrix: &Matrix3<f64>) -> Self {
        ...
        Self {
            rotation_radians,
            mirroring: Mirroring { x: mirroring_x, y: mirroring_y },
            origin: Vector2::new(0.0, 0.0),
            offset,
            scale,
        }
...
mod transform_tests {
    ...
    fn test_combined_transforms_example() {
        ...
        println!("combined1_matrix: rotation={}, offset={:?}, origin={:?}, scale={}",
        ...
        println!("combined2_matrix: rotation={}, offset={:?}, origin={:?}, scale={}",
    ...
    fn test_mirroring_transforms() {
        ...
        let mirror_x = GerberTransform {
            rotation_radians: 0.0,
            mirroring: Mirroring { x: true, y: false },
            origin: Vector2::new(0.0, 0.0),
            offset: Vector2::new(0.0, 0.0),
            scale: 1.0,
        };
    ...
    fn test_rotation_around_different_centers() {
        ...
        println!("Combined for box2: {:?}", [box2_after_combined.x, box2_after_combined.y]);

        println!("box1_combined: rotation={}, offset={:?}, origin={:?}, scale={}",
                 box1_combined.rotation_radians,
                 [box1_combined.offset.x, box1_combined.offset.y],
                 [box1_combined.origin.x, box1_combined.origin.y],
                 box1_combined.scale);

        println!("box2_combined: rotation={}, offset={:?}, origin={:?}, scale={}",
